...
export default () => {
    ...
    useEffect(() => {
        const directions = [
            ...
            { selector: '.arrow_5', x: '-35vw', y: '-450px', delay: 2 },
            { selector: '.arrow_6', x: '30vw', y: '-300px', delay: 2.5 },
            { selector: '.arrow_7', x: '35vw', y: '-400px', delay: 3 },
            { selector: '.arrow_8', x: '25vw', y: '-500px', delay: 3.5 },
            { selector: '.arrow_9', x: '-25vw', y: '-300px', delay: 4 },
            { selector: '.arrow_10', x: '-40vw', y: '-500px', delay: 4.5 },
        ];
